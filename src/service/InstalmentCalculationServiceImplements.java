...
public class InstalmentCalculationServiceImplements implements InstalmentCalculationService {
    ...
    public List<Instalment> calculate(InputData inputData) {
        ...
        for (BigDecimal index = instalmentsNumber.add(BigDecimal.ONE); instalmentsNumber.compareTo(inputData.getNumberInstalments()) <= 0; index = index.add(BigDecimal.ONE)) {
